const Nin =require ("../models/NinData.js");
const User =require ("../models/UserModel.js");
const { Op } =require ("sequelize");



const getNin = async(req,res) =>{
    try{
        let response;
        if(req.role ==="admin"){
...
const ninSearchh = async(req,res) =>{
...
const getNinById = async (req, res) => {
    try {
...
const getDataByConfirmed = async(req, res) =>{
    try{
        let response;
        if(req.role ==="admin"){
            response = await Nin.findAll({
...
const getDataByRejected = async(req, res) =>{
    try{
        let response;
        if(req.role ==="admin"){
            response = await Nin.findAll({
