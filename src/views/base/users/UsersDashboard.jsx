...
//REJECTED 
  ...
  const progressGroupExample2 = [
    { title: 'NCRA NIN DATA', icon: cilUserFemale, value:nin.length, color:"warning" },
    { title: 'NCRA NIN CONFIRM', icon: cilUserFemale, value: dataByConfirmed.length },
    { title: 'NCRA NIN REJECT', icon: cilUserFemale, value: dataByRejected.length },
  ]
